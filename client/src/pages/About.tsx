...
const About = () => {
  return (
    <div className="py-20 px-4 max-w-xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About SamyState</h1>
      ...
      <p className="mb-4 text-slate-700">
        ...
        a property should be an exciting and rewarding experience, 
        and we are dedicated to making that a reality for each and 
